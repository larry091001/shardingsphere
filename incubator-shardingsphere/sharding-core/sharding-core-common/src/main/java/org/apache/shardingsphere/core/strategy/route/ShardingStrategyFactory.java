...
public final class ShardingStrategyFactory {
    ...
    public static ShardingStrategy newInstance(final ShardingStrategyConfiguration shardingStrategyConfig) {
        ...
        //TODO larry 库分片策略
        if(shardingStrategyConfig instanceof DatabaseShardingStrategyConfiguration) {
        	return new DatabaseShardingStrategy((DatabaseShardingStrategyConfiguration) shardingStrategyConfig);
        }
